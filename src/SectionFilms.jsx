                ...
                <div className="container">
                    ...
                    <div className="film_box">
                        <div className="film_card">
                            ...
                            <p className="film_text">At first glance, you can decide that Wakanda is an ordinary territory of wild Africa,
                                but this is not so. Here, in the bowels of the desert lands, there are hidden deposits of a unique metal
                        ...
                        <div className="film_card">
                            ...
                            <p className="film_text">Batman raises stakes in the war on crime. With the help of Lieutenant Jim Gordon
                                and Attorney Harvey Dent, he intends to clear the streets of crime that is poisoning the city. 
                        ...
                        <div className="film_card">
                            ...
                            <p className="film_text">One cunning American, from his student years, 
                                had been selling drugs, and now he came up with a scheme of illegal 
                                enrichment using the estates of an impoverished English aristocracy and 
                                made a very good fortune on ...</p>
                        </div>
                        <div className="film_card">
                            <a href="#!" className="film_play">
                                <img src={Play} alt="" />
